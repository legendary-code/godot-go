...
// in the parent package. IsEditorHint reads the Engine singleton; Print /
// Printf / Printerr capture caller info and route to Godot's Output dock;
// RunOnMain / DrainMain / IsMainThread re-export the framework's main-
// thread queue.
package runtime
...
// Print logs args to Godot's Output dock as a warning. Caller info is captured
// automatically.
func Print(args ...any) {
...
// Printerr logs args as an error.
