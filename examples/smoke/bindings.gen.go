...
func (n *MyNode) GetGraph() DialogGraph { return n.Graph }

func (n *MyNode) SetGraph(v DialogGraph) { n.Graph = v }

func (n *MyNode) GetText() DialogText { return n.Text }

func (n *MyNode) SetText(v DialogText) { n.Text = v }
...
func registerMyNode() {
	...
	gdextension.RegisterClassMethod(gdextension.ClassMethodDef{
		...
		Call: func(instance unsafe.Pointer, args []gdextension.VariantPtr, ret gdextension.VariantPtr) gdextension.CallErrorType {
			...
			result_dict := godot.NewDictionary()
			for kIn_, vIn_ := range result {
				k_v := godot.NewVariantInt(int64(kIn_))
	...
	gdextension.RegisterClassMethod(gdextension.ClassMethodDef{
		...
		Call: func(instance unsafe.Pointer, args []gdextension.VariantPtr, ret gdextension.VariantPtr) gdextension.CallErrorType {
			...
			defer arg0_keys.Destroy()
			arg0_n := arg0_keys.Size()
			arg0 := make(map[Stance][]string, arg0_n)
			var arg0_def godot.Variant
			for arg0_i := int64(0); arg0_i < arg0_n; arg0_i++ {
				arg0_kv := arg0_keys.Get(arg0_i)
				arg0_vv := arg0_dict.Get(arg0_kv, arg0_def)
				k_ := Stance(godot.VariantAsInt64(gdextension.VariantPtr(unsafe.Pointer(&arg0_kv))))
				v__arr := godot.VariantAsPackedStringArray(gdextension.VariantPtr(unsafe.Pointer(&arg0_vv)))
				v__n := v__arr.Size()
				v_ := make([]string, v__n)
				for v__i := int64(0); v__i < v__n; v__i++ {
					v_[v__i] = v__arr.Get(v__i)
				}
				v__arr.Destroy()
				arg0[k_] = v_
				arg0_kv.Destroy()
